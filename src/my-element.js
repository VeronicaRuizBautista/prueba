...
export class MyElement extends LitElement{
  ...
  constructor(){
    ...
    this.imagen = "../src/storage/img/metroboom.png"
  ...
  <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
      ...
      <div class="container">
        ...
        <div class="change_song">
          <img src="../src/storage/img/Group 45.svg" class="aleatory">
          <img src="../src/storage/img/Group.svg"  class="left">
          <img src="../src/storage/img/play button.svg" class="play">
          <img src="../src/storage/img/Group right.svg" class="right">
          <img src="../src/storage/img/Group 44.svg" class="rewind">
        </div>

        <div class="song_volumen">

          <div class="volumen_line">
            <img src="../src/storage/img/low_sound.svg" class="aleatory">
            <input type="range" name="slider" id="slide2">
            <img src="../src/storage/img/up_sound.svg" class="aleatory">
          </div>

        </div>
        <div class="dispositive">
          <div class="info_dispositive">
            <img src="../src/storage/img/Vector.svg" class="aleatory">
